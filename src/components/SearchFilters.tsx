    ...
    <div className="flex flex-wrap items-center gap-3 px-4 py-3">
      ...
      <div className="relative min-w-[200px] flex-1">
        ...
        <input
          ...
          className="w-full rounded-lg bg-surface-input py-2 pl-9 pr-9 text-sm text-primary placeholder-muted outline-none ring-1 ring-border focus:ring-accent"
        />
        {filters.search && (
          <button
      ...
      <select
        ...
        className="rounded-lg bg-surface-input px-3 py-2 text-sm text-primary outline-none ring-1 ring-border focus:ring-accent"
      >
      ...
      <button
        ...
        className={`flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm transition ${
          filters.favoritesOnly
            ...
            : 'bg-surface-input text-secondary ring-1 ring-border hover:text-amber-400'
        }`}
      >
